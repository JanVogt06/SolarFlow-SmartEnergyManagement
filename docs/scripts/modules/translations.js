export const translations = {
    en: {
        ...
        'quickstart.step1.desc': 'Get latest Release',
        'quickstart.step2.title': 'Configuration',
        'quickstart.step2.desc': 'Adjust devices.json to your system',
        'quickstart.step3.title': 'Start',
        'quickstart.step3.desc': 'Start the Energy Manager with correct IP-Address',
    ...
    de: {
        ...
        'quickstart.step1.title': 'Installation',
        'quickstart.step1.desc': 'Installiere den neuesten Release',
        'quickstart.step2.title': 'Konfiguration',
        'quickstart.step2.desc': 'Passe die devices.json an deine Anlage an',
        'quickstart.step3.title': 'Start',
        'quickstart.step3.desc': 'Starte den Energy Manager mit korrekter IP-Adresse',
